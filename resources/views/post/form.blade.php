<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="grid grid-cols-1 mt-5 mx-7">
            ...
            {{ Form::file('imagen_url', '', ['class' => 'form-control' . ($errors->has('imagen_url') ? ' is-invalid' : ''), 'placeholder' => 'Imagen Url']) }}
            {!! $errors->first('imagen_url', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('Contenido') }}
            {{ Form::textarea('Contenido','', ['class' => 'form-control' . ($errors->has('Contenido') ? ' is-invalid' : ''), 'placeholder' => 'Contenido']) }}
